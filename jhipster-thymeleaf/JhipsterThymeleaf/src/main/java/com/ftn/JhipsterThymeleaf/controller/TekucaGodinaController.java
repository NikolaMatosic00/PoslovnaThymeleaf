...
@Controller
@RequestMapping(value = "/TekucaGodina")
public class TekucaGodinaController {
    @Autowired
    TekucaGodinaService service;
    @Autowired
    ...
    public ModelAndView get(HttpSession ses, HttpServletResponse res) throws IOException {
        ...
        List<TekucaGodina> list = service.findAll();
        ModelAndView response = new ModelAndView("tekucaGodinaGet");
